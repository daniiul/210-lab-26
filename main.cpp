// COMSC-210 | 210-lab-26 | Daniil Malakhov
// IDE used: Codeblocks
#include <iostream>
#include <chrono>
#include <list>
...
int main() {
    ...
    cout << setw(10) << right << "Sort" << setw(10) << right << averages[1][0] << setw(10) << right << averages[1][1] << setw(10) << right << averages[1][2] << endl;
    cout << setw(10) << right << "Insert" << setw(10) << right << averages[2][0] << setw(10) << right << averages[2][1] << setw(10) << right << averages[2][2] << endl;
    cout << setw(10) << right << "Delete" << setw(10) << right << averages[3][0] << setw(10) << right << averages[3][1] << setw(10) << right << averages[3][2] << endl;
